...
export const siteContent = {
  ...
  home: {
    ...
    testimonials: {
      ...
      viewMoreLabel: 'View More ↗',
      items: [
        { name: 'John Doe', role: 'Communication Specialist', avatar: null, quote: "I love the great learning opportunities, supportive management, and teamwork available at MediaPal. Additionally, the professional development programs have helped me see positive career growth because I invest in professional development by acquiring new skills and knowledge relevant to the company's field." },
        { name: 'Jane Doe', role: 'Customer Support', avatar: null, quote: "I love the great learning opportunities, supportive management, and teamwork available at MediaPal. Additionally, the professional development programs have helped me see positive career growth because I invest in professional development by acquiring new skills and knowledge relevant to the field." },
      ],
    },
    cta: {
