  ...
  home: {
    ...
    testimonials: {
      ...
      items: [
        ...
        { name: 'Evelyn Saskuku', role: 'Lead of Communications', company: 'Alumni Social Network', avatar: null, quote: "Antony created the materials that tell who we are and why the network exists. They reached our alumni in a way that made them want to be part of it, and our story finally felt consistent." },
        { name: 'Frida', role: 'Founder', company: 'Adili Real Estate', avatar: null, quote: "Most of what Antony designed for us were Meta ads on Facebook and Instagram. The creatives held attention, matched the promise on the ad to the landing page, and converted." },
      ],
    },
    cta: {
