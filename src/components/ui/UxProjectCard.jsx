...
import styles from './UxProjectCard.module.css'

/**
 * UxProjectCard — one large shot per row with a centered "VIEW MORE" button;
 * title left, "Category • Year" right. Used on the /ui-ux list, Home and
 ...
 */
export default function UxProjectCard({ project, to, ratio, ...linkProps }) {
